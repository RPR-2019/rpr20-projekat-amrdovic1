...
public class WelcomeControler
{
    ...
    public void loginClick(ActionEvent actionEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("../login.fxml")); //This path is temporary
    ...
    public void signupClick(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader signUpLoader = new FXMLLoader(getClass().getResource("../register.fxml")); //This path is temporary
